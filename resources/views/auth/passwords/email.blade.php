                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <span class="invalid-feedback" role="alert">
                                        <strong>We can't find a user with that e-mail.</strong>
                                    </span>
                                    @enderror
                                    <div class="restMainBtns mb-0">
                                        <div class="submitResetLink">
                                            <button type="submit" class="btn btn-primary resetpasslinkbtn">
